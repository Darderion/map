    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '20px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', padding: '20px' }}>
                <Text style={{ fontSize: '24px', fontWeight: 'bold', marginBottom: '20px', maxWidth: '700px' }}>Ниже приведен демо файл для тестового прогона программы. Также снизу есть инструкция по использовванию по шагам. Если вам не хватило гайда ниже, то есть видео с более полным обзором существующих возможностей.</Text>
